...
function StepperTrigger({
  ...
  // Uncomment useStepper & useStepItem().step this if click on trigger needed
...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-muted text-foreground data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground relative flex size-8 shrink-0 items-center justify-center rounded-full text-xs border font-medium",
        className
      )}
      data-state={state}
      {...props}
